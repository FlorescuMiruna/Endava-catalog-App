...
//        if(insertData ) {
        ...
        addTeacher("Marius", "Ciobanu", "2344565748391", 99999L);
        addTeacher("Marius", "Popescu", "2344565748392", 99999L);
        addTeacher("Marian", "Ciobanu", "2344565748393", 99999L);
        addTeacher("Alina", "Coman", "2344565748394", 99999L);
        addTeacher("Sorina", "Angelescu", "2344565748395", 99999L);
//        }
    }
